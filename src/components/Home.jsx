    ...
    <div name="home" className="w-full h-screen bg-[#0a192f]">
        ...
        <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
            ...
            <div>
                ...
                <button className="text-white border-2 px-6 py-3 my-2 flex items-center hover:border-yellow-300">
                      <a href="https://docs.google.com/document/d/1fdJ-iBceguClSOTl35afv4psxpZOEV2_ZblU8GJkRrU/edit?usp=sharing" target="_blank" rel="noopener noreferrer" download="Resume for Ben Koenig">{"Resume"}</a>
                </button>
            </div>
        </div>
    </div>
